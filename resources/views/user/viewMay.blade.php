            ...
            <div class="col-12">
                <div class="card mb-30">
                    <div class="card-body pt-30">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="font-20">Schedule for May</h4>
                            </div>
                            <div class="col-6 text-right">
                                <a href="{{ route('viewApril') }}" class="btn btn-primary">Previous</a>
                                <a href="{{ route('viewJune') }}" class="btn btn-primary">Next</a>
                            </div>
                        </div>
                    </div>
