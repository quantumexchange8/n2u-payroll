                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="theme-input-style" id="working_hour" name="working_hour" autocomplete="off" placeholder="Working Hour">
                                            </div>
                                            <!-- End Form Group -->
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="theme-input-style" id="bank_name" name="bank_name" autocomplete="off" placeholder="Bank Name">
                                            </div>
                                            <!-- End Form Group -->
