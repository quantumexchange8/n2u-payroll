                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-20">
                                        ...
                                        <input type="text" id="f_name" name="f_name" class="theme-input-style" placeholder="First Name">
                                    </div>
                                    <!-- End Form Group -->
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-20">
                                        ...
                                        <input type="text" id="e_id" name="e_id" class="theme-input-style" placeholder="Employee ID">
                                    </div>
                                    <!-- End Form Group -->
                                </div>
